...
const dataProjects = [
    ...
    // 02-beachhouse
    {
        ...
        content: [
            { type: "text-file", src: "desc.txt", title: " ", bold: true, layout: "full" },
            { type: "image", src: "023.webp", layout: "full"  , hoverText: "Neighbourhood"},
            { type: "image", src: "9.webp", layout: "full" },
            { type: "text-file", src: "Brief.txt", title: "Breif", layout: "half", matchRow: true },
            { type: "image", src: "09.webp", layout: "mini" , hoverText: "Classic Beach House"},
            { type: "image", src: "018.webp", layout: "mini" , hoverText: "Beach Vibe"},
            { type: 'carousel', layout: 'half', images: ['019.webp', '010.webp', '020.webp',  '021.webp'], matchRow: true},
            { type: "image", src: "blank.webp", layout: "narrow"},
            { type: "text-file", src: "desc01.txt", title: " ", layout: "half", matchRow: true },
            { type: "image", src: "012.webp", layout: "half" , hoverText: "House Before"},
            { type: "image", src: "014.webp", layout: "full" , hoverText: "Site Plan"},
            { type: "text-file", src: "desc02.txt", title: " ", layout: "full", matchRow: true },
            { type: "image", src: "013.webp", layout: "narrow", hoverText: "Under Construction" },
            { type: "image", src: "poster.webp", layout: "narrow", hoverText: "Finished"},
            { type: 'carousel', layout: 'narrow', images: ['03.webp', '04.webp']},  
            { type: "text-file", src: "desc03.txt", title: " ", layout: "half", matchRow: true },
            { type: "image", src: "015.webp", layout: "half", hoverText: "Beach Vibe" },
            { type: "image", src: "016.webp", layout: "mini", hoverText: "Surfboard"},     
            { type: 'carousel', layout: 'center', images: ['2.webp', '5.webp', '11.webp', '12.webp']},
            { type: "image", src: "blank.webp", layout: "mini"},
            { type: "image", src: "022.webp", layout: "mini", hoverText: "Surfboard"},
            { type: "image", src: "024.webp", layout: "full"},
            { type: 'carousel', layout: 'half', images: ['10.webp', '3.webp', '8.webp']},
            { type: "image", src: "017.webp", layout: "mini", hoverText: "Wave" },      
            { type: "text-file", src: "desc04.txt", title: " ", layout: "half"},
            { type: "text-file", src: "desc05.txt", title: " ", layout: "half", matchRow: true },         
            { type: 'carousel', layout: 'half', images: ['05.webp', '6.webp']},  
            { type: 'carousel', layout: 'half', images: ['7.webp', '06.webp']},          
            { type: "image", src: "1.webp", layout: "half" },
            { type: "text-file", src: "Material.txt", title: "Material", layout: "half", matchRow: true },
            { type: "text-file", src: "Credits.txt", title: "", layout: "narrow", matchRow: true },
            { type: 'carousel', layout: 'half', images: ['13.webp', '14.webp']},
            { type: 'floating-video', src: '1205828421', ratio: "56.25%" },
  ...
  // 15-cm-soho
    ...
    //  01-cm-mia
    {
        ...
        content: [
            ...
            { type: "video", provider: "vimeo", src: "1205410624", sound: true, layout: "narrow", ratio: "100%"},
            { type: "image", src: "blank.webp", layout: "narrow"},
            ...
            { type: 'carousel', layout: 'center', images: ['014.webp', '013.webp', '021.webp', '020.webp']},
            { type: "video", provider: "vimeo", src: "1205709720", layout: "mini", ratio: "177.78%"},
            ...
            { type: 'carousel', layout: 'half', images: ['014.webp', '017.webp', '015.webp', '016.webp']},
